...
/>
        ...
        <div className="absolute bottom-7 left-1/2 flex -translate-x-1/2 items-center gap-3 rounded-full border border-white/60 bg-white/78 px-4 py-2 text-xs font-semibold uppercase tracking-[0.16em] text-[color:var(--brand-primary)] shadow-[0_14px_34px_rgba(15,76,129,0.12)]">
  ...
  return (
    <section className="relative min-h-screen overflow-x-hidden text-[color:var(--text-dark)]">
      ...
      <div className="page-container relative z-10 py-6 sm:py-10">
        <div className="mx-auto grid min-h-[90vh] max-w-6xl overflow-visible rounded-[1.8rem] border border-[rgba(15,76,129,0.08)] bg-[linear-gradient(180deg,rgba(255,255,255,0.96),rgba(247,251,255,0.95))] shadow-[0_30px_80px_rgba(4,12,26,0.14)] lg:grid-cols-[1.05fr_0.95fr] lg:rounded-[2.2rem]">
            ...
            <div className="w-full max-w-md rounded-[1.45rem] border border-[rgba(15,76,129,0.08)] bg-white/88 p-4 shadow-[0_18px_40px_rgba(22,50,79,0.08)] backdrop-blur-sm sm:max-w-xl sm:p-6 lg:max-w-md lg:border-0 lg:bg-transparent lg:p-0 lg:shadow-none">
              ...
              <div className="mb-6 flex flex-col gap-3">
                <button
                  ...
                  className="inline-flex w-fit items-center gap-2 rounded-full border border-[rgba(15,76,129,0.12)] bg-white px-4 py-2 text-sm font-medium text-[color:var(--text-dark)] shadow-sm transition hover:bg-[rgba(15,76,129,0.05)]"
                >
