        ...
        <div className="w-full max-w-[54rem]">
          <div className="flex flex-col gap-3.5 rounded-[1.5rem] border border-[rgba(15,76,129,0.08)] bg-[linear-gradient(180deg,rgba(255,255,255,0.98),rgba(243,248,255,0.98))] p-3.5 text-[color:var(--text-dark)] shadow-[0_24px_56px_rgba(22,50,79,0.12)] sm:gap-4 sm:rounded-[1.75rem] sm:p-5">
            ...
            <div className="rounded-[1.25rem] border border-[rgba(15,76,129,0.08)] bg-[linear-gradient(145deg,rgba(255,255,255,0.95),rgba(239,246,255,0.94))] p-3 shadow-[0_18px_38px_rgba(22,50,79,0.08)] sm:rounded-[1.5rem] sm:p-4">
              <div className="flex items-center gap-2.5 md:flex-row md:gap-3">
                ...
                <button
                  ...
                  className="shine-button inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-[0.95rem] bg-[color:var(--brand-accent)] text-white transition duration-200 hover:-translate-y-0.5 hover:bg-[color:var(--brand-accent-deep)] md:h-11 md:w-auto md:gap-2 md:rounded-[1rem] md:px-5"
                  aria-label="Search"
                >
              ...
              {!keyword.trim() ? (
                <div>
                  ...
                  <div className="space-y-2.5">
                    {[
                      ...searchData.courses.slice(0, 2).map((course) => ({ name: course.course, type: "Course" })),
                      ...searchData.cities.slice(0, 1).map((city) => ({ name: city.name, type: "City" })),
                      ...searchData.colleges.slice(0, 1).map((college) => ({ name: college.name, type: "College" })),
                    ].map((item) => (
                      <button
                        key={item.name}
                        type="button"
