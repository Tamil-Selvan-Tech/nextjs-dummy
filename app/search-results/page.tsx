            ...
            <div className="mt-3 rounded-[1.3rem] border border-[rgba(15,76,129,0.08)] bg-[linear-gradient(145deg,rgba(255,255,255,0.95),rgba(239,246,255,0.94))] p-3 shadow-[0_18px_38px_rgba(22,50,79,0.08)] sm:mt-4 sm:p-4">
              <div className="flex items-center gap-2.5 md:gap-3">
                ...
                <button
                  ...
                  className="shine-button inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-[0.95rem] bg-[color:var(--brand-accent)] text-white transition duration-200 hover:-translate-y-0.5 hover:bg-[color:var(--brand-accent-deep)] md:w-auto md:gap-2 md:rounded-[1rem] md:px-5"
                  ...
                  <div className="space-y-2.5">
                    {matchingCourses.map((item) => (
                      <button
                        ...
                        className="group flex w-full items-center justify-between gap-3 rounded-[1rem] border border-[rgba(15,76,129,0.06)] bg-[linear-gradient(180deg,rgba(255,255,255,1),rgba(245,249,255,0.96))] px-4 py-3 text-left transition duration-200 hover:-translate-y-0.5 hover:border-[rgba(255,138,61,0.24)]"
                      >
                        <div>
