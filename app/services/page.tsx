...
export default function ServicesPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="overflow-hidden bg-white font-sans text-slate-800">
        <Navbar />
      ...
      <section className="page-section bg-white py-8 font-sans text-slate-800">
            ...
            {servicePrograms.map((service) => {
              ...
              return (
                <Link
                  ...
                  className="group flex h-full flex-col rounded-[1.2rem] border border-[rgba(15,76,129,0.08)] bg-white p-4 shadow-[0_10px_24px_rgba(22,50,79,0.05)] transition hover:-translate-y-1"
                >
                  <div
      ...
      <section className="page-section bg-white py-8 font-sans text-slate-800">
        <div className="page-container-full px-4 sm:px-6">
          <div className="rounded-[1.4rem] border border-[rgba(15,76,129,0.1)] bg-white p-5 shadow-[0_12px_28px_rgba(22,50,79,0.05)]">
